...
const CHECKLIST_ITEMS = [
  ...
  { key: 'infodesk_prod_qa_dev_aws_v6_v7', label: 'InfoDesk Prod/QA/Dev AWS V6 and V7' },
  { key: 'jira_and_wiki', label: 'JIRA and Wiki' },
  { key: 'ms_office', label: 'MS Office' },
  { key: 'atlas_mongo_access', label: 'Atlas Mongo Access For QA/Dev/Prod' },
  { key: 'aws', label: 'AWS' },
  { key: 'azure', label: 'Azure' },
  { key: 'infodesk_v7_wn_vpn', label: 'InfoDesk V7 and WN VPN' },
  { key: 'azure_devops', label: 'Azure Devops' },
  { key: 'infoadmin', label: 'InfoAdmin' },
  { key: 'zabbix', label: 'Zabbix Dev/QA/Prod' },
  { key: 'infodesk_wn_github', label: 'InfoDesk and WN GitHub' },
